...
if ($stmt = mysqli_prepare($connection, 'SELECT username, email, token FROM user WHERE token=?')) {
    ...
    if (isset($_POST['password']) && isset($_POST['confirm'])) {
        if ($_POST['password'] === $_POST['confirm']) {
            ...
            if ($stmt = mysqli_prepare($connection, "UPDATE user SET token='', password='{$hashed_password}' WHERE email = ?")) {
                        ...
                        <div class="text-center">
                            ...
                            <div class="panel-body">
                                <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                                    ...
                                    <div class="form-group">
                                        <input name="reset" class="btn btn-lg btn-primary btn-block"
